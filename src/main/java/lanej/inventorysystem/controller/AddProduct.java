...
/**
 * The AddProduct class is responsible for managing the user interface and functionality of the Add Product screen in
 * the inventory management system. This class implements the Initializable interface from the JavaFX API.
 * It contains text fields, tables, and buttons for adding the details of a new product, including its
 * associated parts. The class allows users to search, add, and remove parts from the associated parts table, as well
 * as save and cancel the addition of this new product.
 * @author Jonathan Lane
 */
public class AddProduct implements Initializable {
    /** Displays the Product's ID, which is automatically generated */
    ...
    /** The Product that is being added. It's necessary as a buffer in case the user decides to cancel the addition. */
    ...
    /**
     * This method is called by the FXMLLoader when the add-product.fxml file is loaded. It sets the initial values
     * for all the fields in the screen, and populates the parts table. It also initializes the sorting and filtering
     * functionality for both the all parts table and the associated parts table.
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        System.out.println("AddProduct Controller Initialized");
        idField.setText("" + InventoryApplication.nextProductId() + " – Generated");
     ...
     * (that is then added to Inventory). It gets the new Product's ID from InventoryApplication.nextProductId().
    ...
    public void saveButton(ActionEvent event) {
        try {
            ...
            productToAdd.setId(InventoryApplication.nextProductId());
        }
        catch (IllegalArgumentException e) {
            System.err.println("User input in AddProduct is invalid! " + e.getMessage());
